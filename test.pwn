...
public CompileTest()
{
	...
	TextDrawAlignment(INVALID_TEXT_DRAW, 0);
	TextDrawColor(INVALID_TEXT_DRAW, 0);
	TextDrawUseBox(INVALID_TEXT_DRAW, 0);
	...
	TextDrawFont(INVALID_TEXT_DRAW, 0);
	TextDrawSetProportional(INVALID_TEXT_DRAW, 0);
	TextDrawSetSelectable(INVALID_TEXT_DRAW, 0);
	...
	ShowPlayerDialog(0, 0, 0, "STRING", "STRING", "STRING", "STRING");
	gpci(0, output, _);
	...
	PlayerTextDrawAlignment(0, INVALID_PLAYER_TEXT_DRAW, 0);
	PlayerTextDrawColor(0, INVALID_PLAYER_TEXT_DRAW, 0);
	PlayerTextDrawUseBox(0, INVALID_PLAYER_TEXT_DRAW, 0);
	...
	PlayerTextDrawFont(0, INVALID_PLAYER_TEXT_DRAW, 0);
	PlayerTextDrawSetProportional(0, INVALID_PLAYER_TEXT_DRAW, 0);
	PlayerTextDrawSetSelectable(0, INVALID_PLAYER_TEXT_DRAW, 0);
	...
	StartRecordingPlayerData(0, 0, "STRING");
